const Imprint = () => {
  return (
    <div className="flex flex-col items-center justify-start text-left bg-pnp-white text-pnp-black gap-5 p-5 pb-10 max-w-4xl mx-auto rounded-3xl">
      <h2 className="text-3xl font-bold mt-3 mb-4">Imprint & Terms of Use</h2>
      <ol className="list-decimal list-inside space-y-4">
        ...
        <li>
          ...
          <p>
            {" "}
            Harassment, hate speech, discriminatory behavior, or any form of
            abuse is strictly prohibited. Violations may result in account
        ...
        <li>
          ...
          <p>
            {" "}
            Users are responsible for the content they post. Content must be
            relevant, lawful, and appropriate. The platform reserves the right
            to remove content that violates these terms or disrupts community
            harmony.{" "}
          </p>{" "}
        </li>{" "}
        <li>
        ...
        <li>
          ...
          <p>
            {" "}
            The platform may integrate third-party services or tools, each
        ...
        <li>
          ...
          <p>
            ...
            accounts for violations of these terms or disruptive behavior.{" "}
          </p>{" "}
        </li>{" "}
        <li>
          {" "}
        ...
        <li>
          ...
          <p>
            ...
            exclusive jurisdiction of the German courts.{" "}
          </p>{" "}
        </li>{" "}
      </ol>{" "}
      <p>
